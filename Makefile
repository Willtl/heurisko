#############################################################################
# Makefile for building: Heurisko
# Generated by qmake (3.1) (Qt 5.10.1)
# Project:  Heurisko.pro
# Template: app
# Command: /opt/Qt5.10.1/5.10.1/gcc_64/bin/qmake -o Makefile Heurisko.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CXXFLAGS      = -pipe -O3 -fopenmp -pthread -g -std=gnu++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I../../workspace/qt/SatelliteStructureOptimization/eigen/Eigen -I/opt/Qt5.10.1/5.10.1/gcc_64/include -I/opt/Qt5.10.1/5.10.1/gcc_64/include/QtCore -I. -I/opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Heurisko1.0.0
DISTDIR = /home/willian/Gitkraken/heurisko/.tmp/Heurisko1.0.0
LINK          = g++
LFLAGS        = -fopenmp -Wl,-rpath,/opt/Qt5.10.1/5.10.1/gcc_64/lib
LIBS          = $(SUBLIBS) -L/opt/Qt5.10.1/5.10.1/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
		...
		Heurisko.pro entities/solution.h \
		entities/problem.h \
		...
		solvers/solver.h \
		util/util.h \
		examples/combinatorial/indirect/tsp.h main.cpp
QMAKE_TARGET  = Heurisko
DESTDIR       = 
TARGET        = Heurisko
...
Makefile: Heurisko.pro /opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Heurisko.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents entities/solution.h entities/problem.h examples/continuous/direct/functions.h examples/continuous/indirect/rastrigin.h examples/continuous/direct/ackley.h examples/continuous/direct/crossintray.h solvers/differentialevolution.h solvers/globalsolver.h solvers/geneticalgorithm.h solvers/greywolfoptimizer.h solvers/particleswarmoptimization.h solvers/solver.h util/util.h examples/combinatorial/indirect/tsp.h $(DISTDIR)/
...
moc_predefs.h: /opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -O3 -fopenmp -pthread -g -std=gnu++11 -Wall -W -dM -E -o moc_predefs.h /opt/Qt5.10.1/5.10.1/gcc_64/mkspecs/features/data/dummy.cpp
...
main.o: main.cpp entities/solution.h \
		solvers/differentialevolution.h \
		entities/problem.h \
		util/util.h \
		solvers/globalsolver.h \
